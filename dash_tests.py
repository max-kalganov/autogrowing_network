...
# App
app.layout = dash.html.Div(style=styles['container'], children=[
    dash.html.Div([
        dash.html.Button("Responsive Toggle", id='toggle-button'),
        dash.html.Div(id='toggle-text')
    ]),
    dash.html.Div(className='cy-container', style=styles['cy-container'], children=[
        cyto.Cytoscape(
